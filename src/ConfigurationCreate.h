...
//        CONFIGURATION_CREATE_EXECUTOR_DONE_CHECK_WAITING,
        ...
        CONFIGURATION_CREATE_DISCRETE_SIGNALS_TEXT_TITLES_COMMON_TO_WORK_CREATE_START,
        CONFIGURATION_CREATE_DISCRETE_SIGNALS_TEXT_TITLES_COMMON_TO_WORK_CREATE_EXECUTOR_ANSWER_PROCESSING,
