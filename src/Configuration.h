...
#define FRAM_ANALOGUE_MEASURE_ARCHIVE_FRAM_POSITION_DATA_OFFSET (FRAM_LAST_SAVED_TIME_OFFSET + FRAM_LAST_SAVED_TIME_ARRAY_LENGTH)
#define FRAM_ANALOGUE_MEASURE_ARCHIVE_FRAM_POSITION_DATA_LENGTH sizeof(struct TAnalogueSignalsArchiveFramPositionData)
#define FRAM_ANALOGUE_MEASURE_ARCHIVE_ARRAY_OFFSET (FRAM_ANALOGUE_MEASURE_ARCHIVE_FRAM_POSITION_DATA_OFFSET + FRAM_ANALOGUE_MEASURE_ARCHIVE_FRAM_POSITION_DATA_LENGTH)
