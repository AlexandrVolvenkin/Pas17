#ifndef CSUBSTRACTIONMATHEMATICALFUNCTIONALBLOCK_H
#define CSUBSTRACTIONMATHEMATICALFUNCTIONALBLOCK_H
//-----------------------------------------------------------------------------------------------------
//  Source      : FileName.cpp
//  Created     : 01.06.2022
...
//struct TSubstractionMathematicalFunctionalBlockDescriptor
//{
...
//-----------------------------------------------------------------------------------------------------
class CSubstractionMathematicalFunctionalBlockJob :
	public CGeneralMathematicalFunctionalBlockJob
{
public:

	CSubstractionMathematicalFunctionalBlockJob();
	virtual ~CSubstractionMathematicalFunctionalBlockJob();
...
//-----------------------------------------------------------------------------------------------------
class CSubstractionMathematicalFunctionalBlockManager :
	public CGeneralMathematicalFunctionalBlockManager
{
public:

	CSubstractionMathematicalFunctionalBlockManager();
	virtual ~CSubstractionMathematicalFunctionalBlockManager();
//    virtual void Fsm(void);
...
//-----------------------------------------------------------------------------------------------------
class CSubstractionMathematicalFunctionalBlockExecutor :
	public CGeneralMathematicalFunctionalBlockExecutor
{
public:

	CSubstractionMathematicalFunctionalBlockExecutor();
	virtual ~CSubstractionMathematicalFunctionalBlockExecutor();
