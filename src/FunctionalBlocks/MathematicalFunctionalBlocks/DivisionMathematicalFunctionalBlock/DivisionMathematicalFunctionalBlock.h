#ifndef CDIVISIONMATHEMATICALFUNCTIONALBLOCK_H
#define CDIVISIONMATHEMATICALFUNCTIONALBLOCK_H
//-----------------------------------------------------------------------------------------------------
//  Source      : FileName.cpp
//  Created     : 01.06.2022
...
//struct TDivisionMathematicalFunctionalBlockDescriptor
//{
...
//-----------------------------------------------------------------------------------------------------
class CDivisionMathematicalFunctionalBlockJob :
	public CGeneralMathematicalFunctionalBlockJob
{
public:

	CDivisionMathematicalFunctionalBlockJob();
	virtual ~CDivisionMathematicalFunctionalBlockJob();
...
//-----------------------------------------------------------------------------------------------------
class CDivisionMathematicalFunctionalBlockManager :
	public CGeneralMathematicalFunctionalBlockManager
{
public:

	CDivisionMathematicalFunctionalBlockManager();
	virtual ~CDivisionMathematicalFunctionalBlockManager();
//    virtual void Fsm(void);
...
//-----------------------------------------------------------------------------------------------------
class CDivisionMathematicalFunctionalBlockExecutor :
	public CGeneralMathematicalFunctionalBlockExecutor
{
public:

	CDivisionMathematicalFunctionalBlockExecutor();
	virtual ~CDivisionMathematicalFunctionalBlockExecutor();
	virtual void Fsm(void);
