...
public:
    enum
    {
        ...
        SYSTEM_COMPONENTS_CREATE_DISCRETE_SIGNALS_SERVICE_DATA_CREATE_START,
        SYSTEM_COMPONENTS_CREATE_DISCRETE_SIGNALS_SERVICE_DATA_CREATE_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        SYSTEM_COMPONENTS_CREATE_DISCRETE_SIGNALS_SERVICE_DATA_CREATE_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,

        SYSTEM_COMPONENTS_CREATE_DISCRETE_SIGNALS_TEXT_TITLES_COMMON_TO_WORK_CREATE_START,
        SYSTEM_COMPONENTS_CREATE_DISCRETE_SIGNALS_TEXT_TITLES_COMMON_TO_WORK_CREATE_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        SYSTEM_COMPONENTS_CREATE_DISCRETE_SIGNALS_TEXT_TITLES_COMMON_TO_WORK_CREATE_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
