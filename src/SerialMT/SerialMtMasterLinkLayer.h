#ifndef CSERIALMTMASTERLINKLAYER_H
#define CSERIALMTMASTERLINKLAYER_H
//-------------------------------------------------------------------------------
//  Source      : FileName.cpp
//  Created     : 01.06.2022
...
//-------------------------------------------------------------------------------
class CSerialMtMasterLinkLayerInterface : public CTask
{
public:
    enum
    {
...
//    CSerialMtMasterLinkLayerInterface();
//    virtual ~CSerialMtMasterLinkLayerInterface();
...
//-------------------------------------------------------------------------------
class CSerialMtMasterLinkLayer : public CSerialMtMasterLinkLayerInterface
{
public:
    CSerialMtMasterLinkLayer();
    virtual ~CSerialMtMasterLinkLayer();
...
//-------------------------------------------------------------------------------
#endif // CSERIALMTMASTERLINKLAYER_H
