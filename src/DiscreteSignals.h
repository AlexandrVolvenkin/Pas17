...
public:
    enum
    {
        ...
        DISCRETE_SIGNALS_PROCESSING_ALARM_HANDLERS_START,
        DISCRETE_SIGNALS_PROCESSING_ALARM_HANDLERS_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        DISCRETE_SIGNALS_PROCESSING_ALARM_HANDLERS_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
    };
