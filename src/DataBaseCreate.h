...
public:
    enum
    {
        ...
        DATA_BASE_CREATE_SETTINGS_DATA_BASE_BLOCKS_WRITE_START,
        DATA_BASE_CREATE_SETTINGS_DATA_BASE_BLOCKS_WRITE_EXECUTOR_ANSWER_PROCESSING,
