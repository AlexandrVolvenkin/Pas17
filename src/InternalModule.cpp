...
CInternalModule::~CInternalModule()
{
    ...
    // удал€ть не нужнор. это не указатели на выделенную пам€ть.
...
//    // ѕолучим указатель на место в массиве дискретных входов дл€ текущего модул€.
//    m_puiDiscreteInputs =
//        &xMemoryAllocationContext.
//        puiDiscreteInputs[xMemoryAllocationContext.uiUsedDiscreteInputs];
//    // ”величим общий объЄм выделенной пам€ти.
//    xMemoryAllocationContext.
//    uiUsedDiscreteInputs +=
//        MVSN21_DISCRETE_INPUTS_NUMBER;
//
//    // ѕолучим указатель на место в массиве достоверности дискретных входов дл€ текущего модул€.
...
//        MVSN21_DISCRETE_INPUTS_NUMBER;
//
//    // ѕолучим указатель на место в массиве состо€ний ошибок дл€ текущего модул€.
...
//        std::cout << "CInternalModule::GetModuleType 3"  << std::endl;
        // обмен данными прошЄл без ошибок?
...
//                std::cout << "CInternalModule::SearchModules 3"  << std::endl;
                ...
                // сохраним тип модул€ в массиве дл€ упор€дочивани€ следовани€ модулей при поиске на SPI.
                pxDeviceConfigSearch ->
                axModulesContext[pxDeviceConfigSearch -> uiModulesQuantity].uiType = uiType;
                // сохраним адрес модул€ в массиве дл€ упор€дочивани€ следовани€ модулей при поиске на SPI.
                pxDeviceConfigSearch ->
                ...
                // перейдЄм к опросу следующего адреса.
                break;
            }
        }
...
//    std::cout << "CInternalModule::ServiceDataCreate 1"  << std::endl;
    ...
    // вычисление служебных переменных дл€ внутренних модулей.
    for (uint8_t i = 0;
