...
//-------------------------------------------------------------------------------
void CGpio::SetPin(int iLineHandler)
{
//    std::cout << "CGpio::SetPin 1"  << std::endl;
    ...
    ioctl(iLineHandler, GPIOHANDLE_SET_LINE_VALUES_IOCTL, &GPIO);
}

//-------------------------------------------------------------------------------
void CGpio::ClearPin(int iLineHandler)
{
