...
public:
    enum
    {
        ...
        SETTINGS_SET_SETTINGS_DATA_BASE_BLOCKS_WRITE_START,
        SETTINGS_SET_SETTINGS_DATA_BASE_BLOCKS_WRITE_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        SETTINGS_SET_SETTINGS_DATA_BASE_BLOCKS_WRITE_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
    };
