...
public:
    enum
    {
        ...
        SETTINGS_LOAD_STOP_RTU_UPPER_LEVEL_INTERFACE,
        ...
        SETTINGS_LOAD_START_RTU_UPPER_LEVEL_INTERFACE,
//
//		SETTINGS_LOAD_MODULE_MUVR_DATA_BASE_BLOCK_READ_START,
//        SETTINGS_LOAD_MODULE_MUVR_DATA_BASE_BLOCK_READ_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
//        SETTINGS_LOAD_MODULE_MUVR_DATA_BASE_BLOCK_READ_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
//
//		SETTINGS_LOAD_DATA_BASE_BLOCK_MODULE_MUVR_WRITE_START,
//        SETTINGS_LOAD_DATA_BASE_BLOCK_MODULE_MUVR_WRITE_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
//        SETTINGS_LOAD_DATA_BASE_BLOCK_MODULE_MUVR_WRITE_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
    };
