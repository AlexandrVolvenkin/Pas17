...
{
    // Освобождаем память
    for (auto& pair : m_mxCommonTaskMap)
    {
...
//    m_lpxCommonTasksList.push_back(pxTask);
//    m_mxCommonTaskMap[sTaskName].push_back(pxTask);
    m_mxCommonTaskMap[sTaskName] = pxTask;
}
