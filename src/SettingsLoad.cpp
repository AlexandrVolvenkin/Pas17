...
//-------------------------------------------------------------------------------
            ...
            const char* interface = "eth0"; // «амените на ваше сетевое интерфейс
//            const char* old_ip = "192.168.0.9";
//            const char* new_ip = "192.168.0.8";
            const char* new_netmask = "255.255.255.0";

//            // —оздаем сокет дл€ управлени€ сетевыми устройствами
