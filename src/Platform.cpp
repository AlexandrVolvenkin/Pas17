...
//
////-----------------------------------------------------------------------------------------------------
//void CCommunicationDevice::Initialization(void) { }
//void CCommunicationDevice::SetPortName(const char* pccDeviceName) { }
//const char* CCommunicationDevice::GetPortName(void) { }
//void CCommunicationDevice::SetBaudRate(uint32_t uiBaudRate) { }
//void CCommunicationDevice::SetDataBits(uint8_t uiDataBits) { }
//void CCommunicationDevice::SetParity(char cParity) { }
//void CCommunicationDevice::SetStopBit(uint8_t uiStopBit) { }
//
//void CCommunicationDevice::SetIpAddress(const char* pccIpAddress) { }
//const char* CCommunicationDevice::GetIpAddress(void) { }
//void CCommunicationDevice::SetPort(uint16_t uiPort) { }
//
//int8_t CCommunicationDevice::Open(void) { }
//int8_t CCommunicationDevice::Close(void) { }
//int16_t CCommunicationDevice::Write(uint8_t * , uint16_t ) { }
//int16_t CCommunicationDevice::Read(uint8_t * , uint16_t ) { }
//int CCommunicationDevice::Exchange(unsigned char *pucTxBuff,
//                                   unsigned char *pucRxBuff,
//                                   int iLength,
//                                   int iSpeed) { }
//int CCommunicationDevice::Exchange(uint8_t uiAddress,
//                                   unsigned char *pucTxBuff,
//                                   unsigned char *pucRxBuff,
//                                   int iLength,
//                                   int iSpeed) { }
//bool CCommunicationDevice::IsDataWrited(void) { }
//void CCommunicationDevice::ChipSelectPinSet(void) { }
//void CCommunicationDevice::ChipSelectPinDelete(void) { }
//void CCommunicationDevice::ChipSelectAddressSet(unsigned char ucAddress) { }
//
////-----------------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------------------------
void CTcpCommunicationDevice::Initialization(void)
{
#if defined(OS_BSD)
...
//-----------------------------------------------------------------------------------------------------
CSpi::CSpi(const char* pccDeviceName) :
    m_pccDeviceName(pccDeviceName)
...
//    ULONG  ulMode32 = SPI_MODE32;
    ...
    while (1)
    {
        if ((m_iDeviceDescriptor = open(m_pccDeviceName, O_RDWR | O_SYNC)) < 0)
        {
...
////-----------------------------------------------------------------------------------------------------
//int16_t CSpi::Read(uint8_t *puiDestination, uint16_t uiLength)
//{
//    return 0;
//}
//
////-----------------------------------------------------------------------------------------------------
//int16_t CSpi::Write(uint8_t *puiSource, uint16_t uiLength)
//{
//    m_bDataIsWrited = true;
//    return 0;
//}
...
//-----------------------------------------------------------------------------------------------------
// производит обмен данными по SPI.
int CSpi::Exchange(unsigned char *pucTxBuff,
                   unsigned char *pucRxBuff,
                   int iLength,
                   int iSpeed)
{
...
//    memset(auiSpiTxBuffer, 0, iLength);
//    memset(auiSpiRxBuffer, 0, iLength);
//    memset(auiSpiRxBuffer, 0, 4);
...
//-----------------------------------------------------------------------------------------------------
void CGpio::Initialization(void)
{
    Open();
};
...
//-----------------------------------------------------------------------------------------------------
void CPlatform::Initialization(void)
{

}

//-----------------------------------------------------------------------------------------------------
void CPlatform::LedInitialization(void)
{
    CGpio::SetPinOutput(PRD_EN_PIN_PORT, PRD_EN_PIN);
    CGpio::SetPinOutput(PRD_3_PIN_PORT, PRD_3_PIN);
    CGpio::SetPinOutput(PRD_2_PIN_PORT, PRD_2_PIN);
    CGpio::SetPinOutput(PRD_1_PIN_PORT, PRD_1_PIN);

    CGpio::ClearPin(PRD_EN_PIN_PORT, PRD_EN_PIN);
    CGpio::ClearPin(PRD_3_PIN_PORT, PRD_3_PIN);
    CGpio::ClearPin(PRD_2_PIN_PORT, PRD_2_PIN);
    CGpio::ClearPin(PRD_1_PIN_PORT, PRD_1_PIN);
}

void CPlatform::LedDestroy(void)
{
    CGpio::SetPinInput(PRD_EN_PIN_PORT, PRD_EN_PIN);
    CGpio::SetPinInput(PRD_3_PIN_PORT, PRD_3_PIN);
    CGpio::SetPinInput(PRD_2_PIN_PORT, PRD_2_PIN);
    CGpio::SetPinInput(PRD_1_PIN_PORT, PRD_1_PIN);
