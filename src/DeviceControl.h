...
public:
    ...
    enum
    {
        ...
        SERIAL_PORT_COMMUNICATION_DEVICE_UPPER_LEVEL_SETTINGS_WRITE_INTERFACE_RESTART_START,
        SERIAL_PORT_COMMUNICATION_DEVICE_UPPER_LEVEL_SETTINGS_WRITE_INTERFACE_RESTART_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        SERIAL_PORT_COMMUNICATION_DEVICE_UPPER_LEVEL_SETTINGS_WRITE_INTERFACE_RESTART_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
