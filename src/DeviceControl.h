...
public:
    enum
    {
        ...
        MODBUS_FUNCTION_5_HANDLER_ACKNOWLEDJEMENT_COMAND_START,
        MODBUS_FUNCTION_5_HANDLER_ACKNOWLEDJEMENT_COMAND_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        MODBUS_FUNCTION_5_HANDLER_ACKNOWLEDJEMENT_COMAND_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
