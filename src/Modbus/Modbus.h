...
#define _FC_WRITE_SINGLE_COIL         0x48//0x05//
...
#define _FC_STATE_DATA_READ  0x41//0x05//
#define _FC_ANALOGUE_MEASURE_ARCHIVE_WRITE  0x42
#define _FC_ANALOGUE_MEASURE_ARCHIVE_WRITE_STATE_REQUEST  0x43//0x05//

#define _FC_DEVICE_CONTROL_DOMAIN_DATA_WRITE  0x05//0x48//
#define _FC_DEVICE_CONTROL_DOMAIN_DATA_READ  0x49
...
//        EXECUTOR_ANSWER_PROCESSING_CONFIRMATION,
