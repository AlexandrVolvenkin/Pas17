...
public:
    enum
    {
        ...
        REQUEST_PROCESSING,
        REQUEST_PROCESSING_EXECUTOR_READY_CHECK_NO_DONE_CHECK_START,
        REQUEST_PROCESSING_EXECUTOR_READY_CHECK_NO_DONE_CHECK_WAITING,
        REQUEST_PROCESSING_EXECUTOR_READY_CHECK_START,
        REQUEST_PROCESSING_EXECUTOR_READY_CHECK_WAITING,
        REQUEST_PROCESSING_EXECUTOR_DONE_CHECK_START,
        REQUEST_PROCESSING_EXECUTOR_DONE_CHECK_WAITING,
