...
//-----------------------------------------------------------------------------------------------------
// производит обмен данными с модулями функционального блока «МВМ» функция Modbus - 4.
int iMbmFunction4DataHandler(TModuleContext *pxModuleContext)
{
    ...
    i = modbus_read_input_registers(pxMasterRtuCtx,
...
//                                                  ucMaxCodeL));
    ...
    {
//printf("iMbmFunction3DataHandler -1 %d\n\r", (i));
