...
public:
    ...
    enum
    {
        ...
        CONFIGURATION_CONFIRMATION_WAITING_ERROR_HANDLER_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        CONFIGURATION_CONFIRMATION_WAITING_ERROR_HANDLER_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
