...
public:
    ...
    enum
    {
        MAIN_CYCLE_BOOT_SOURCE_CHECK = NEXT_STEP,
		...
		MAIN_CYCLE_MODULE_MUVR_DATA_BASE_BLOCK_READ_START,
        MAIN_CYCLE_MODULE_MUVR_DATA_BASE_BLOCK_READ_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        MAIN_CYCLE_MODULE_MUVR_DATA_BASE_BLOCK_READ_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,

		MAIN_CYCLE_DATA_BASE_BLOCK_MODULE_MUVR_WRITE_START,
        MAIN_CYCLE_DATA_BASE_BLOCK_MODULE_MUVR_WRITE_EXECUTOR_DONE_OK_ANSWER_PROCESSING,
        MAIN_CYCLE_DATA_BASE_BLOCK_MODULE_MUVR_WRITE_EXECUTOR_DONE_ERROR_ANSWER_PROCESSING,
